...
const LANG_STRINGS = {
  en: {
    ...
    enable_tng: 'Enable Touch & Go eWallet Payment',
    enable_duitnow: 'Enable DuitNow QR Payment',
    duitnow_payment_link: 'DuitNow — Payment Link',
    duitnow_qr_image: 'DuitNow — QR Image URL (optional)',
  ...
  zh: {
    ...
    enable_tng: '启用 Touch & Go 电子钱包支付',
    enable_duitnow: '启用 DuitNow QR 支付',
    duitnow_payment_link: 'DuitNow — 支付链接',
    duitnow_qr_image: 'DuitNow — 二维码图片URL（可选）',
  ...
  th: {
    ...
    enable_tng: 'เปิดใช้ Touch & Go eWallet',
    enable_duitnow: 'เปิดใช้ DuitNow QR',
    duitnow_payment_link: 'DuitNow — ลิงก์ชำระเงิน',
    duitnow_qr_image: 'DuitNow — URL รูป QR (ไม่บังคับ)',
  ...
  vi: {
    ...
    enable_tng: 'Bật thanh toán Touch & Go eWallet',
    enable_duitnow: 'Bật thanh toán DuitNow QR',
    duitnow_payment_link: 'DuitNow — Liên kết thanh toán',
    duitnow_qr_image: 'DuitNow — URL hình QR (tùy chọn)',
  ...
  ms: {
    ...
    enable_tng: 'Aktifkan Bayaran Touch & Go eWallet',
    enable_duitnow: 'Aktifkan Bayaran DuitNow QR',
    duitnow_payment_link: 'DuitNow — Pautan Bayaran',
    duitnow_qr_image: 'DuitNow — URL Imej QR (pilihan)',
  ...
  km: {
    ...
    enable_tng: 'បើកការបង់ប្រាក់តាម Touch & Go eWallet',
    enable_duitnow: 'បើកការបង់ប្រាក់តាម DuitNow QR',
    duitnow_payment_link: 'DuitNow — តំណបង់ប្រាក់',
    duitnow_qr_image: 'DuitNow — URL រូប QR (ជម្រើស)',
  ...
  id: {
    ...
    enable_tng: 'Aktifkan Pembayaran Touch & Go eWallet',
    enable_duitnow: 'Aktifkan Pembayaran DuitNow QR',
    duitnow_payment_link: 'DuitNow — Tautan Pembayaran',
    duitnow_qr_image: 'DuitNow — URL Gambar QR (opsional)',
